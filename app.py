...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Thị Hường - Trường TH Nguyễn Trãi - Phường Hà Giang 1 - ĐT: 0944604867 </div>", unsafe_allow_html=True)
